...
*
*	The way this program handles the code is to paralli
*
*/
int main(int argc, char** argv) {
	...
	*/
	...
	/*
	*	With the input variables and internal variables defined,
	*	create a semaphore and fork the different processes.
	*/
